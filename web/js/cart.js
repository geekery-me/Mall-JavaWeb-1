    ...
    $(".num .sub").click(function () {
        ...
        if (c <= 1) {
            ...
            if ($(this).siblings("span").attr("datasrc")){
                // alert(c);
                var url="cartupdatequantity?count="+c+"&cart_id="+$(this).siblings("span").attr("datasrc");
                $.get(url,function () {});
            }
    ...
    $(".del").click(function () {
        if ($(this).parent().parent().hasClass("th")) {
            ...
            if ($(this).attr("datasrc")){
                ...
                var url="deletecart?cart_id="+$(this).attr("datasrc");
                $.get(url,function () {});
            }
    ...
    function deletemore(){
        ...
        for (var i=0;i<elements.length;i++){
            if (elements[i].checked==true){
                var f = document.getElementById("my");
                f.submit();
